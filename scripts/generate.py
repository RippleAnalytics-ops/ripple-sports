...
[data-theme="light"]{--bg:#e2e0ee;--surface:#f5f3ff;--surface2:#ebe8fa;--border:rgba(0,0,0,0.09);--border-hover:rgba(140,82,255,0.35);--ink:#0a0a0f;--ink2:#3a3950;--ink3:#8888aa}
